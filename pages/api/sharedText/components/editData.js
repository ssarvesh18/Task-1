    ...
    return (
        <div >
            <form onSubmit={handleSubmit}>
                <label for="msgId" className={styles.label}>Enter the message ID to be edited</label><br/><br/>
                <input
                    type="text"
                    id="msgId"
                    name="msgId"
                ...
                /><br/><br/>
                <label for="textData" className={styles.label}>Enter edited message :</label><br/><br/>
                <input 
                    type="text"
                    id="textData"
                    name="textData"
